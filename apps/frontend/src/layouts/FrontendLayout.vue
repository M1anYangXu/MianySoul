<template>
  <div
    class="min-h-screen relative transition-all duration-500"
    :class="
      isDark
        ? 'bg-gradient-to-br from-slate-900 via-primary-900/20 to-accent-900/20'
        : 'bg-gradient-to-br from-white via-primary-50/30 to-accent-50/30'
    "
  >
    <nav
          ...
          <div class="hidden md:flex items-center space-x-8">
            <template v-for="item in navItems" :key="item.href">
              <div v-if="item.children && item.children.length" class="relative group">
                <a
                  :href="item.href"
                  class="relative flex items-center text-lg font-bold transition-colors duration-300"
                  :class="
                    isScrolled
                      ? isDark
                ...
                >
                  ...
                  {{ item.label }}
                  <span
                    class="absolute -bottom-1 left-0 w-0 h-0.5 group-hover:w-full transition-all duration-300 bg-gradient-to-r from-primary-500 to-accent-500"
                  ></span>
                </a>
                <div
                ...
                >
                  <a
                    ...
                    :key="child.href"
                    :href="child.href"
                    class="block px-3 py-2 text-sm font-bold transition-colors duration-200"
                    :class="
                      isDark
              ...
              <a
                v-else
                :href="item.href"
                class="relative group flex items-center text-lg font-bold transition-colors duration-300"
                :class="
                  isScrolled
                    ? isDark
                      ? 'text-primary-400 hover:text-primary-300'
          ...
          <div class="flex items-center space-x-4">
            <button
              ...
              :class="
                isScrolled
                  ? isDark
                    ? 'hover:bg-white/10 text-primary-400'
